...
#ifndef WEBAUTH_TLS_CHOOSER_H
#define WEBAUTH_TLS_CHOOSER_H
 ...
 *
 *  When the portal adapter is in use this window never appears: the smart card service
 ...
 *  the purpose, because this is the moment the service stops rendering a page and starts

 ...
 *  or a query string either, and its logging offers no entry point that could.
 *  Duplicating the implementation would be worse than sharing the rule; if these
 *  helpers ever move, they belong in xdg-desktop-portal's shared code next to the
 *  completion matcher, for the same reason.
 *
